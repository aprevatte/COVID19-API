...
Scatterplot of total cases over time by region
...
Scatterplot of daily case count  

```{r, scatterplot2}
# Ending at 1 less than number of rows to account for the NA removed in the combinedAll dataset. 
